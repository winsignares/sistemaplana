      ...
      for (let index = 1; index < length; index++) {
        ...
        mostrar += ` <tr">
                ...
                <td> <button class="btxn" onclick="openModal(${datos[index].id})">Castigo</button> 
                 ...
                 <img style="cursor:pointer;" onclick="eliminar(${datos[index].id})" src="https://cdn.icon-icons.com/icons2/1993/PNG/512/bin_delete_file_garbage_recycle_remove_trash_icon_123192.png" >
                 </td>
              </tr> `;
